  ...
  return (
    <main className=" h-screen flex items-center justify-center xl:justify-start max-w-[1400px] mx-auto">
      ...
      <div className="hidden relative xl:block flex-grow h-full animate-fade opacity-0 fill-mode-forwards">
        ...
        <div className="h-96 w-96 scale-100 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full overflow-hidden flex justify-center items-center z-40 transition-all hover:scale-125 hover:z-50 hover:outline outline-4 outline-black">
